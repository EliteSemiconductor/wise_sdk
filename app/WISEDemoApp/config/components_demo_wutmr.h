...
#define DMA_CH2_FUNC 									SYS_DMA_FUNC_AES_OUT
...
// default use internal 16K as LFOSC clock source
// for users using external 32K crystal, the following macros must be defined.
//#define ES_DEVICE_LFOSC_SELECT							SYS_LFOSC_CLK_SRC_EXTERNAL_32K
//#define ES_DEVICE_LFOSC_OPTION							LFOSC_32K_MODE_32K
