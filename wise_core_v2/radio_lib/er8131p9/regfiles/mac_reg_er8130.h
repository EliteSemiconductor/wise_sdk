...
/* ================                      MAC_T                     ================ */
/* ================================================================================ */
//csr_table_mac_xs_e1_20250805.xlsx
/**
  * @brief MAC (MAC_T)
  */
 ...
 typedef struct {                                          /*!< MAC_T Structure                                                            */
  ...
  __IO uint32_t THREE6_CFG0;                               /*!< THREE6_CFG0 Register (0x0E0)                                               */
  __IO uint32_t THREE6_CFG1;                               /*!< THREE6_CFG1 Register (0x0E4)                                               */
  __IO uint32_t CRC_REG_EXT3;                              /*!< CRC_REG_EXT3 Register (0x0E8)                                              */
} MAC_T;
...
#define MAC_RXEN_TRN_MBUS_ADDR                             (uint32_t)&(MAC->RX_TOP)
#define MAC_RXEN_TRN_MBUS_POS                              (2)      /*< bit[2]      */
#define MAC_RXEN_TRN_MBUS_MASK                             (0x1ul << MAC_RXEN_TRN_MBUS_POS)
...
#define MAC_RX_PHR_EXCLUDE_CRC_ADDR                        (uint32_t)&(MAC->RX_802)
#define MAC_RX_PHR_EXCLUDE_CRC_POS                         (16)     /*< bit[16]     */
#define MAC_RX_PHR_EXCLUDE_CRC_MASK                        (0x1ul << MAC_RX_PHR_EXCLUDE_CRC_POS)
#define MAC_RX_PHR_EXCLUDE_CRC_AUTO_ADDR                   (uint32_t)&(MAC->RX_802)
#define MAC_RX_PHR_EXCLUDE_CRC_AUTO_POS                    (17)     /*< bit[17]     */
#define MAC_RX_PHR_EXCLUDE_CRC_AUTO_MASK                   (0x1ul << MAC_RX_PHR_EXCLUDE_CRC_AUTO_POS)
...
#define MAC_DATCOL_BBP_BITINV_ADDR                         (uint32_t)&(MAC->RX_DATCOL)
#define MAC_DATCOL_BBP_BITINV_POS                          (5)      /*< bit[5]      */
#define MAC_DATCOL_BBP_BITINV_MASK                         (0x1ul << MAC_DATCOL_BBP_BITINV_POS)
...
#define MAC_CRC_STANDALONE_ERR_ADDR                        (uint32_t)&(MAC->TX_STS)
#define MAC_CRC_STANDALONE_ERR_POS                         (4)      /*< bit[4]      */
#define MAC_CRC_STANDALONE_ERR_MASK                        (0x1ul << MAC_CRC_STANDALONE_ERR_POS)
...
#define MAC_TX_PHR_EXCLUDE_CRC_ADDR                        (uint32_t)&(MAC->TX_CFG)
#define MAC_TX_PHR_EXCLUDE_CRC_POS                         (15)     /*< bit[15]     */
#define MAC_TX_PHR_EXCLUDE_CRC_MASK                        (0x1ul << MAC_TX_PHR_EXCLUDE_CRC_POS)
...
#define MAC_INT_ST_CRC_STANDALONE_ERR_ADDR                 (uint32_t)&(MAC->INT_ST)
#define MAC_INT_ST_CRC_STANDALONE_ERR_POS                  (7)      /*< bit[7]      */
#define MAC_INT_ST_CRC_STANDALONE_ERR_MASK                 (0x1ul << MAC_INT_ST_CRC_STANDALONE_ERR_POS)
#define MAC_INT_ST_MBUS_C_FA_ADDR                          (uint32_t)&(MAC->INT_ST)
#define MAC_INT_ST_MBUS_C_FA_POS                           (8)      /*< bit[8]      */
#define MAC_INT_ST_MBUS_C_FA_MASK                          (0x1ul << MAC_INT_ST_MBUS_C_FA_POS)
#define MAC_INT_ST_MBUS_C_FB_ADDR                          (uint32_t)&(MAC->INT_ST)
#define MAC_INT_ST_MBUS_C_FB_POS                           (9)      /*< bit[9]      */
#define MAC_INT_ST_MBUS_C_FB_MASK                          (0x1ul << MAC_INT_ST_MBUS_C_FB_POS)
#define MAC_INT_ST_MBUS_ERR_ADDR                           (uint32_t)&(MAC->INT_ST)
#define MAC_INT_ST_MBUS_ERR_POS                            (10)     /*< bit[10]     */
#define MAC_INT_ST_MBUS_ERR_MASK                           (0x1ul << MAC_INT_ST_MBUS_ERR_POS)
...
#define MAC_INT_EN_CRC_STANDALONE_ERR_ADDR                 (uint32_t)&(MAC->INT_EN)
#define MAC_INT_EN_CRC_STANDALONE_ERR_POS                  (7)      /*< bit[7]      */
#define MAC_INT_EN_CRC_STANDALONE_ERR_MASK                 (0x1ul << MAC_INT_EN_CRC_STANDALONE_ERR_POS)
#define MAC_INT_EN_MBUS_C_FA_ADDR                          (uint32_t)&(MAC->INT_EN)
#define MAC_INT_EN_MBUS_C_FA_POS                           (8)      /*< bit[8]      */
#define MAC_INT_EN_MBUS_C_FA_MASK                          (0x1ul << MAC_INT_EN_MBUS_C_FA_POS)
#define MAC_INT_EN_MBUS_C_FB_ADDR                          (uint32_t)&(MAC->INT_EN)
#define MAC_INT_EN_MBUS_C_FB_POS                           (9)      /*< bit[9]      */
#define MAC_INT_EN_MBUS_C_FB_MASK                          (0x1ul << MAC_INT_EN_MBUS_C_FB_POS)
#define MAC_INT_EN_MBUS_ERR_ADDR                           (uint32_t)&(MAC->INT_EN)
#define MAC_INT_EN_MBUS_ERR_POS                            (10)     /*< bit[10]     */
#define MAC_INT_EN_MBUS_ERR_MASK                           (0x1ul << MAC_INT_EN_MBUS_ERR_POS)
...
#define MAC_INT_CRC_STANDALONE_ERR_ADDR                    (uint32_t)&(MAC->INT)
#define MAC_INT_CRC_STANDALONE_ERR_POS                     (7)      /*< bit[7]      */
#define MAC_INT_CRC_STANDALONE_ERR_MASK                    (0x1ul << MAC_INT_CRC_STANDALONE_ERR_POS)
#define MAC_INT_MBUS_C_FA_ADDR                             (uint32_t)&(MAC->INT)
#define MAC_INT_MBUS_C_FA_POS                              (8)      /*< bit[8]      */
#define MAC_INT_MBUS_C_FA_MASK                             (0x1ul << MAC_INT_MBUS_C_FA_POS)
#define MAC_INT_MBUS_C_FB_ADDR                             (uint32_t)&(MAC->INT)
#define MAC_INT_MBUS_C_FB_POS                              (9)      /*< bit[9]      */
#define MAC_INT_MBUS_C_FB_MASK                             (0x1ul << MAC_INT_MBUS_C_FB_POS)
#define MAC_INT_MBUS_ERR_ADDR                              (uint32_t)&(MAC->INT)
#define MAC_INT_MBUS_ERR_POS                               (10)     /*< bit[10]     */
#define MAC_INT_MBUS_ERR_MASK                              (0x1ul << MAC_INT_MBUS_ERR_POS)
...
#define MAC_CRC_INCLUDE_PHR_ADDR                           (uint32_t)&(MAC->CRC_REG)
#define MAC_CRC_INCLUDE_PHR_POS                            (28)     /*< bit[28]     */
#define MAC_CRC_INCLUDE_PHR_MASK                           (0x1ul << MAC_CRC_INCLUDE_PHR_POS)
#define MAC_CRC_ALTCHK_ADDR                                (uint32_t)&(MAC->CRC_REG)
#define MAC_CRC_ALTCHK_POS                                 (29)     /*< bit[29]     */
#define MAC_CRC_ALTCHK_MASK                                (0x1ul << MAC_CRC_ALTCHK_POS)
#define MAC_CRC_ENDIAN_IN_FCS_ADDR                         (uint32_t)&(MAC->CRC_REG)
#define MAC_CRC_ENDIAN_IN_FCS_POS                          (30)     /*< bit[30]     */
#define MAC_CRC_ENDIAN_IN_FCS_MASK                         (0x1ul << MAC_CRC_ENDIAN_IN_FCS_POS)
...
#define MAC_CRC_STANDALONE_EN_ADDR                         (uint32_t)&(MAC->TX_CRC_STANDALONE)
#define MAC_CRC_STANDALONE_EN_POS                          (0)      /*< bit[0]      */
#define MAC_CRC_STANDALONE_EN_MASK                         (0x1ul << MAC_CRC_STANDALONE_EN_POS)
...
#define MAC_THREE6_CFG0_ADDR                               (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_RX_3OF6DE_EN_ADDR                              (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_RX_3OF6DE_EN_POS                               (0)      /*< bit[0]      */
#define MAC_RX_3OF6DE_EN_MASK                              (0x1ul << MAC_RX_3OF6DE_EN_POS)
#define MAC_THREE6DE_INBITREV_ADDR                         (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_THREE6DE_INBITREV_POS                          (1)      /*< bit[1]      */
#define MAC_THREE6DE_INBITREV_MASK                         (0x1ul << MAC_THREE6DE_INBITREV_POS)
#define MAC_THREE6DE_OUTBITREV_ADDR                        (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_THREE6DE_OUTBITREV_POS                         (2)      /*< bit[2]      */
#define MAC_THREE6DE_OUTBITREV_MASK                        (0x1ul << MAC_THREE6DE_OUTBITREV_POS)
#define MAC_THREE6DE_HBREV_ADDR                            (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_THREE6DE_HBREV_POS                             (3)      /*< bit[3]      */
#define MAC_THREE6DE_HBREV_MASK                            (0x1ul << MAC_THREE6DE_HBREV_POS)
#define MAC_TX_3OF6EN_EN_ADDR                              (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_TX_3OF6EN_EN_POS                               (4)      /*< bit[4]      */
#define MAC_TX_3OF6EN_EN_MASK                              (0x1ul << MAC_TX_3OF6EN_EN_POS)
#define MAC_THREE6EN_INBITREV_ADDR                         (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_THREE6EN_INBITREV_POS                          (5)      /*< bit[5]      */
#define MAC_THREE6EN_INBITREV_MASK                         (0x1ul << MAC_THREE6EN_INBITREV_POS)
#define MAC_THREE6EN_OUTBITREV_ADDR                        (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_THREE6EN_OUTBITREV_POS                         (6)      /*< bit[6]      */
#define MAC_THREE6EN_OUTBITREV_MASK                        (0x1ul << MAC_THREE6EN_OUTBITREV_POS)
#define MAC_THREE6EN_HBREV_ADDR                            (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_THREE6EN_HBREV_POS                             (7)      /*< bit[7]      */
#define MAC_THREE6EN_HBREV_MASK                            (0x1ul << MAC_THREE6EN_HBREV_POS)
#define MAC_BYP_BIT_EN_ADDR                                (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_BYP_BIT_EN_POS                                 (8)      /*< bit[8]      */
#define MAC_BYP_BIT_EN_MASK                                (0x1ul << MAC_BYP_BIT_EN_POS)
#define MAC_BYP_BIT_ADDR                                   (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_BYP_BIT_POS                                    (9)      /*< bit[14:9]   */
#define MAC_BYP_BIT_MASK                                   (0x3Ful << MAC_BYP_BIT_POS)
#define MAC_CMODE_DET_INBITREV_ADDR                        (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_CMODE_DET_INBITREV_POS                         (15)     /*< bit[15]     */
#define MAC_CMODE_DET_INBITREV_MASK                        (0x1ul << MAC_CMODE_DET_INBITREV_POS)
#define MAC_CMODE_DET_EN_ADDR                              (uint32_t)&(MAC->THREE6_CFG0)
#define MAC_CMODE_DET_EN_POS                               (16)     /*< bit[16]     */
#define MAC_CMODE_DET_EN_MASK                              (0x1ul << MAC_CMODE_DET_EN_POS)

#define MAC_THREE6_CFG1_ADDR                               (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_0_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_0_OPT_POS                             (0)      /*< bit[4:0]    */
#define MAC_THREE6EN_0_OPT_MASK                            (0x1Ful << MAC_THREE6EN_0_OPT_POS)
#define MAC_THREE6EN_1_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_1_OPT_POS                             (5)      /*< bit[8:5]    */
#define MAC_THREE6EN_1_OPT_MASK                            (0xFul << MAC_THREE6EN_1_OPT_POS)
#define MAC_THREE6EN_2_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_2_OPT_POS                             (9)      /*< bit[10:9]   */
#define MAC_THREE6EN_2_OPT_MASK                            (0x3ul << MAC_THREE6EN_2_OPT_POS)
#define MAC_THREE6EN_3_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_3_OPT_POS                             (11)     /*< bit[13:11]  */
#define MAC_THREE6EN_3_OPT_MASK                            (0x7ul << MAC_THREE6EN_3_OPT_POS)
#define MAC_THREE6EN_4_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_4_OPT_POS                             (14)     /*< bit[15:14]  */
#define MAC_THREE6EN_4_OPT_MASK                            (0x3ul << MAC_THREE6EN_4_OPT_POS)
#define MAC_THREE6EN_5_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_5_OPT_POS                             (16)     /*< bit[17:16]  */
#define MAC_THREE6EN_5_OPT_MASK                            (0x3ul << MAC_THREE6EN_5_OPT_POS)
#define MAC_THREE6EN_6_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_6_OPT_POS                             (18)     /*< bit[18]     */
#define MAC_THREE6EN_6_OPT_MASK                            (0x1ul << MAC_THREE6EN_6_OPT_POS)
#define MAC_THREE6EN_7_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_7_OPT_POS                             (19)     /*< bit[19]     */
#define MAC_THREE6EN_7_OPT_MASK                            (0x1ul << MAC_THREE6EN_7_OPT_POS)
#define MAC_THREE6EN_8_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_8_OPT_POS                             (20)     /*< bit[21:20]  */
#define MAC_THREE6EN_8_OPT_MASK                            (0x3ul << MAC_THREE6EN_8_OPT_POS)
#define MAC_THREE6EN_9_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_9_OPT_POS                             (22)     /*< bit[23:22]  */
#define MAC_THREE6EN_9_OPT_MASK                            (0x3ul << MAC_THREE6EN_9_OPT_POS)
#define MAC_THREE6EN_A_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_A_OPT_POS                             (24)     /*< bit[24]     */
#define MAC_THREE6EN_A_OPT_MASK                            (0x1ul << MAC_THREE6EN_A_OPT_POS)
#define MAC_THREE6EN_B_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_B_OPT_POS                             (25)     /*< bit[25]     */
#define MAC_THREE6EN_B_OPT_MASK                            (0x1ul << MAC_THREE6EN_B_OPT_POS)
#define MAC_THREE6EN_C_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_C_OPT_POS                             (26)     /*< bit[26]     */
#define MAC_THREE6EN_C_OPT_MASK                            (0x1ul << MAC_THREE6EN_C_OPT_POS)
#define MAC_THREE6EN_D_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_D_OPT_POS                             (27)     /*< bit[27]     */
#define MAC_THREE6EN_D_OPT_MASK                            (0x1ul << MAC_THREE6EN_D_OPT_POS)
#define MAC_THREE6EN_E_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_E_OPT_POS                             (28)     /*< bit[28]     */
#define MAC_THREE6EN_E_OPT_MASK                            (0x1ul << MAC_THREE6EN_E_OPT_POS)
#define MAC_THREE6EN_F_OPT_ADDR                            (uint32_t)&(MAC->THREE6_CFG1)
#define MAC_THREE6EN_F_OPT_POS                             (29)     /*< bit[29]     */
#define MAC_THREE6EN_F_OPT_MASK                            (0x1ul << MAC_THREE6EN_F_OPT_POS)

#define MAC_CRC_REG_EXT3_ADDR                              (uint32_t)&(MAC->CRC_REG_EXT3)
#define MAC_BASE                                          0x40020000UL
#define MAC                                               ((MAC_T               *) MAC_BASE)

#endif/* __MAC_REG_ER8130_H__ */