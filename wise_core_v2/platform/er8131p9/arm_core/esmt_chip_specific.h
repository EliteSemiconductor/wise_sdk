...
#define CHIP_SOC_UNIQUE "ER8131P9"
#define ESMT_SOC_CHIP_ID 0x9006
...
typedef enum {
    ...
    EXTPMU_IRQn    = 1,  /*!<   1  EXTPMU interrupt    */
    ...
    RESERVED1_IRQn = 29, /*!<  29  Reserved interrupt  */
    EFUSE_IRQn     = 30, /*!<  30  EFUSE interrupt     */
    RESERVED2_IRQn = 31, /*!<  31  Reserved interrupt  */
...
#define CHIP_RADIO_FLEXIBLE_FMT_VERSION         2
#define CHIP_RADIO_SUPPORT_IQK
